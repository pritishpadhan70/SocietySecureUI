...
<br>
<label class="label-title">Delivery Company:</label>
<label for="frequency" id ="frequency">BlueDart</label>
<br>
  <label class="label-title">Visiting Frequency:</label>
<label for="frequency" id ="frequency">Daily</label>
<br>
<label class="label-title">Date of Birth: </label>
    <label for="dob" id ="dob">20/06/2000</label>
    <br>
    <label class="label-title">Age: </label>
    <label for="age" id ="age">20</label>
    <br>
 ...
 <div class="form-group left">
   ...
   <label class="label-title"> Alternate Contact No</label>
		...
		<div class="horizontal-group">
				...
				<div class="form-group right">
					<label for="visiting" class="label-title">Visiting Frequency</label>
