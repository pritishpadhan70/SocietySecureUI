...
<label for="name" id ="name">Supria Sahoo</label>
<br>
   ...
   <label class="label-title"> Alternate Contact No</label>
		...
		<div class="horizontal-group">
			<div class="form-group left ">
				...
				<input type="date" name="date" id="dob" class="form-input"></div> 
			<div class="form-group right">
				<label for="age" class="label-title">Age</label>
        <input type="text" id="age" class="form-input" placeholder="enter your User Age" required="required"> </div>
